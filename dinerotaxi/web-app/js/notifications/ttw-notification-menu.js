...
(function($) {
     ...
     $.ttwNotificationMenu = function(userOptions) {
        ...
        defaults = {
            ...
            notificationListEmptyText:'No hay notificaciones pendientes',
        ...
        NotificationList.prototype.populate = function() {
            ...
            if (!$.isEmptyObject(theNotifications)) {
                ...
                $.each(theNotifications, function(i, notification) {
                	ids.push(notification.idMessage);
                ...
                $.ajax({
			        type: "GET",
			        url: contextPath+"notificationApi/markListNotificationReader?ids="+ids,
        ...
        NotificationList.prototype.bindMenuActions = function() {
            ...
            this.$wrapper.find(cssSelector.notificationListCloseButton).bind('click', function() {
        		...
        		var as=getNotifications("notifications","unread");
        		for(var i in as){
        			window.notifications.deleteNotification(getNotifications("notifications","unread")[i]);
        		}
                self.close();
                isVisible=false;
            });
        ...
        Notification.prototype.create = function() {
            ...
            if (this.settings.message) {
                ...
                this.idMessage = this.settings.idMessage;
        ...
        notificationMenu.deleteNotifications = function(){
          	for (var i = 0; i < notifications.notifications.unreadCount; i++) {
          		notificationMenu.deleteNotification(notifications.notifications.unread[i]);
            }
        };
