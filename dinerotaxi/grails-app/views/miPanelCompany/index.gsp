        ...
        <jqgrid:resources />
	        ...
	        $(document).ready(function() {
                         <jqgrid:grid
                                ...
                                colNames="'UserName','Password','Nombre','Apellido','Telefono','Tipo','Habilitado','Cuenta Bloqueada','id'"
                         ...
                         colNames="'UserName','Password','Telefono','Empresa','CUIT','Habilitado','Cuenta Bloqueada','id'"
...
<div class="mainContent_">
	...
	<div class="con">
		...
		<g:render template="/tripPanel/sidebar" model="['action':'search']" />
        <!-- DETAIL -->
