...
<div class="mainContent_">
	...
	<div class="con">        	
			...
			<g:render template="/tripPanel/sidebar" model="['action':'data']" />
              <!-- DETAIL -->
       	 ...
       	 <div class="boxPanelTaxista">    
                ...
                <div class="itemDatos">
                    ...
                    <div class="itemM">${usr?.companyName }</div>
                    
                </div>
                <div class="itemDatos">
                	
                    <div class="itemM"><b>Cuit</b></div>
                    <div class="itemM">${usr?.cuit }</div>
                ...
                <g:form action="saveModification" controller="miPanelCompany" name="modificationForm">
            
                	<div class="blockInput_"><span class="fl">Nombre*</span>  
                		<input id="companyName" type="text" name="companyName" placeholder="Ej:DineroTaxi" size="34" value="${usr?.companyName}"/>
                	</div>
                    
                	<div class="blockInput_"><span class="fl">Cuit*</span>  
                	<input id="cuit" type="text" name="cuit" placeholder="Ej: 20-3030303123-5" size="34"  value="${usr?.cuit}"/>
                	</div>
