...
<div class="mainContent_">
	...
	<div class="con">
        ...
        <div class="bOX725 mt10">
                ...
                <h1>Obtene la aplicación de DineroTaxi</h1>
                    
                <h3 class="mt10">Comenza la descarga</h3>
                
                <ul>
                	<li>Descarga gratuita</li>
                    <li>Simple e intuitiva</li>
                    <li>Rapida y eficaz</li>
         ...
         <div class="bOX725 mt20">
                ...
                <h1>Eleji según tu dispositivo</h1>
