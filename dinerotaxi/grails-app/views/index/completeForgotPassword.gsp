		   ...
		   <g:if test="${flash.message}">
            ...
            <div id="cont_gracias">
                <div class="contenido_gracias">
                    ...
                    <div class="tit_agradecimiento"><h2> <g:fieldValue bean="${usr}" field="firstName" /> Hemos enviado la recuperación de contraseña a tu correo electronico!!</h2></div>
                    <div class="cont_txt_agradecimiento">
                        <div class="ima_mail"></div>
                        <div class="txt_texto"><p><g:fieldValue bean="${usr}" field="firstName" /> <g:fieldValue bean="${usr}" field="lastName" /> es un placer que nos hayas elegido.<br /> <span class="negro resalta_mas">No olvides verificar tu casilla de e-mail para cambiar tu contraseña</span></p></div>
