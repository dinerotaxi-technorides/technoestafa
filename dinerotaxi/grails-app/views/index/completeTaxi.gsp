            ...
            <div id="cont_gracias">
                <div class="contenido_gracias">
                    ...
                    <div class="cont_txt_agradecimiento">
                        ...
                        <div class="txt_texto"><p>Te enviamos un mail a la cuenta <g:fieldValue bean="${usr}" field="email" /> <br /> <span class="negro">No olvides verificar tu casilla de e-mail para confirmar tu registro</span></p></div>
                        <div class="ima_cel"></div>
               			<div class="txt_texto"><p>¿Tus choferes no poseen dinero taxi en su celular?<br />
                        <span class="negro">Los invitamos a que lo descarguen desde <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" action="comoFuncionaTaxista"/>" title="Descargar aplicación de dinerotaxi para el celular (Acceso por teclado:d)" accesskey="d" >aquí</a></span></p></div>
     ...
     <!-- END LOGIN -->
       ...
       <div class="sidebar">
             ...
             <div id="cont_sabias">
              ...
              <ul class="bjqs">
                    <li><h2>Mayor cantidad de viajes</h2>
                        <p>Con dinerotaxi avisamos los posibles pasajeros que  se encuentran cerca de la posición del móvil, solo basta con aceptar el viaje y listo!! pasajero asegurado</p></li>
                    <li><h2>Seguridad para vos y tus choferes</h2>
                        <p>Sabran de antemano la persona que viaja y el destino del mismo.</p>
                        <p>Dinerotaxi.com te brinda seguridad</p>
                    </li>
                    <li><h2>Gratis!!, totalmente gratis!!</h2>
                        <p>Dinerotaxi.com es completamente gratis, tus choferes solo necesitán un celular con GPS y conexión a internet para comenzar a incrementar los viajes.</p>
                    </li>
                </ul>
            </div>
           <div class="clearFix"><br /></div>
