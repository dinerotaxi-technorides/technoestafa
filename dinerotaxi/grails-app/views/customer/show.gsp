...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link  params="[country:"${params?.country?:''}"]" class="list" action="list"><g:message code="default.list.label" args="[entityName]" /></g:link></span>
            <span class="menuButton"><g:link  params="[country:"${params?.country?:''}"]" class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="customer.age.label" default="Age" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: customerInstance, field: "age")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: customerInstance, field: "emailAddress")}</td>
