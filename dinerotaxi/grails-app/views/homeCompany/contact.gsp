	...
	<div class="con">
    	...
    	<div class="container">
         ...
         <div class="bOX725 mt20">
               ...
               <g:form action="saveContact" controller="homeCompany" name="contactForm">
            
                <div class="blockInput_">
                	<label class="fl" for="firstName">Nombre*</label>
                	<div class="encierra_input">  <input id="firstName" type="text" name="firstName" placeholder="ej:Nombre" size="34" /></div>
                </div>
                
                <div class="blockInput_">
                	<label class="fl" for="lastName">Apellido*</label>  
                	<div class="encierra_input"><input id="lastName" type="text" name="lastName" placeholder="ej: Apellido" size="34" /></div>
               	</div>
                
                <div class="blockInput_"><label class="fl" for="email">Email*</label>  
                	<div class="encierra_input"><input id="email" type="text" name="email" placeholder="ej:ejemplo@mail.com" size="34" /></div>
                </div>
                <div class="blockInput_"><label class="fl" for="phone">Teléfono*</label> 
                	<div class="encierra_input"> <input id="phone" type="text" name="phone" placeholder="ej:1533334444" size="34" /></div>
                </div>
