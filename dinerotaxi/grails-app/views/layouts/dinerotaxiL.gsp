...
<div class="header">
	...
	<div class="con">
        ...
        <div class="logo">
        	...
        	<a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" />"><img src="${resource(dir:'images',file:'dineroTaxi.png')}" alt="DineroTaxi.com" title="DineroTaxi.com" border="0" /></a>

        </div>
           
        <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="download" />" target="_blank" class="download"></a>
...
<div class="topMenu">
    ...
    <div class="con">
    	...
    	<div class="leftMenu">
            ...
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home"  />" class="btn">Realizar Pedido</a> 
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="nosotros" />" class="btn">Nosotros</a> <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="comoFunciona" />" class="btn">¿Cómo funciona?</a>
        ...
        <div class="rightMenu">
            ...
            <img src="${resource(dir:'images',file:'user.png')}" border="0" alt="registración" /></span>
             ...
             <g:link  params="[country:"${params?.country?:''}"]" controller="miPanel" class="btn"><img src="${resource(dir:'images',file:'config.png')}" border="0" alt="Login" /> <span class="adjustment">Mi panel</span></g:link>
...
<div class="footer">
    ...
    <div class="con">
        ...
        <div class="menuBottom">
            ...
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="comoFunciona" />" class="btn">¿Cómo funciona?</a>
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="nosotros" />" class="btn">Nosotros</a>

            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="termsAndConditions" />" class="btn">Términos y condiciones</a>
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="termsAndConditions" />" class="btn">Política de privacidad</a>
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="home" action="contact" />" class="btn">Contactanos</a>
