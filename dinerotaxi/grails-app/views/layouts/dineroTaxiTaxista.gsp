...
<div class="topMenu">
    ...
    <div class="con">
    	...
    	<div class="leftMenu">
            ...
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" action="nosotros" />" class="btn">Nosotros</a> <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" action="comoFuncionaTaxista" />" class="btn">¿Cómo funciona?</a>
        ...
        <div class="rightMenu">
            ...
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" action="registro" />" class="btn"><img src="${resource(dir:'images',file:'register.png')}" border="0" alt="registración" /> <span class="adjustment">Registrarse</span></a>
            
            <a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" action="login" />" class="btn"><img src="${resource(dir:'images',file:'login.png')}" border="0" alt="Login" /> <span class="adjustment">Login</span></a>
