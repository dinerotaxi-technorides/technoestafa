...
<div class="header">
	...
	<div class="con">
        ...
        <div class="logo">
        	...
        	<a href="<g:createLink params="[country:"${params?.country?:''}"]"        controller="index" action="inicio" />"><img src="${resource(dir:'images',file:'dineroTaxi.png')}" alt="DineroTaxi.com"  title="Ir a Inicio (Tecla de Acceso:a)"  border="0" /></a>
