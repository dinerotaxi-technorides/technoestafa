...
<div class="header">
	...
	<div class="con">
        ...
        <div class="logo">
        	...
        	<a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" />"><img src="${resource(dir:'images',file:'dineroTaxi.png')}" alt="DineroTaxi.com"  title="Ir a Inicio (Tecla de Acceso:a)" accesskey="a" border="0" /></a>
