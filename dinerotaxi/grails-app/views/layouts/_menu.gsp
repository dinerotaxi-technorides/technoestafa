...
<header>
	<div class="inner">
		...
		<ol class="right">
			<li class="tw-con22nect"><g:isTwitterLoggedIn>
					<g:form method="DELETE" mapping="springSocialConnect"
						params="[providerId:'twitter']">
						<button class="TWshare">Disconnect from Twitter</button>
					</g:form>
				</g:isTwitterLoggedIn> 
				<g:isTwitterNotLoggedIn>
				<g:form method="POST" mapping="springSocialConnect"
						params="[providerId:'twitter']">
						<button class="TWshare">Connect with Twitter</button>
					</g:form>
			...
			<li class="fb-con22nect"><g:isFacebookLoggedIn>
					<g:form method="DELETE" mapping="springSocialConnect"
...
<nav id="navigation" class="clearfix">
	...
	<ol id="user-log" class="right">
		...
		<sec:ifAllGranted roles="ROLE_ADMIN">
			<li><sec:username /> (<g:link  params="[country:"${params?.country?:''}"]" controller="logout">Logout</g:link>)</li>
		</sec:ifAllGranted>
	</ol>
</nav>