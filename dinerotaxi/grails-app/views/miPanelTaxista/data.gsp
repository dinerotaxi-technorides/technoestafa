	...
	<div class="con">
        ...
        <div class="content mt10">        	
            ...
            <div class="boxPanelUser">
                ...
                <g:form action="saveModification" controller="miPanelTaxista" name="modificationForm">
                    ...
                    <div class="blockInput_"><span class="fl">Email*</span>  
                    <input id="email" type="text" name="email" placeholder="pepe@hotmail.com" size="34"  value="${usr?.email}"/>
                    </div>
