	...
	<div class="mainContent">
		...
		<div class="con">
				...
				<div class="bOX955 mt10">
                            ...
                            <div class="mens_error"><p>Su cuenta fue desactivada para más información contactese com atención al usuario<br />
				<a href="<g:createLink params="[country:"${params?.country?:''}"]"  controller="index" action="customerService" />" title="Atencion al usuario(Acceso por teclado: u)" accesskey="r">Click aquí para ir a Atención al usuario</a></p></div>
		        </div>
			<div class="container">
