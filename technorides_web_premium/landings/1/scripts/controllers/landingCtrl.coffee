technoridesApp.controller 'landingCtrl' , ['$scope','$settings', '$api', '$apiHandler', '$apiAdapter', '$http', '$message','$cookieStore','$location', '$window',($scope, $settings, $api, $apiHandler, $apiAdapter, $http, $message,$cookieStore,$location, $window) ->
  ...
  $scope.sendTrial = (mail) ->
    mail.origin = "(Por Adwords desde Landing 1)"
    mail.plan = "ADWORDS LANDING 1"
